const descriptions = {
  ...
  'Extraversion': {'higher': 'More energetic and pronounced engagement with the external world. Likes high group visibility, talking, and asserting themselves.', 'lower': 'Needs less stimulation and are more independent of their social world. It does not mean you are shy, un-friendly, or antisocial.'},
  'Agreeableness': {'higher': 'Value getting along with others. You have a more optimistic view of human nature.', 'lower': 'Value self interests over others. You are more skeptical of others\' motives.'},
  'Neuroticism': {'higher': 'More likely to have negative emotions or get upset. It could mean you are going through a tough time.', 'lower': 'More calm and less likely to get upset. It does not mean you are positive, or happy person.'},
